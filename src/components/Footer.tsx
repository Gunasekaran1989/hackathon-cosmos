    ...
    <div className="container relative py-16">
      <div className="grid md:grid-cols-4 gap-10 mb-12">
        ...
        {[
          ...
          { title: "Guides", items: [{ label: "What is a hackathon?", href: "/guides/what-is-a-hackathon" }, { label: "Submit an event", href: "/submit" }, { label: "About", href: "#" }, { label: "Organizers", href: "#" }, { label: "Sponsors", href: "#" }, { label: "Contact", href: "/guides/contact" }] },
        ].map(c => (
          <div key={c.title}>
